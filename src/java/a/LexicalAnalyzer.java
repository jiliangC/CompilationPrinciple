...
public class LexicalAnalyzer {
    ...
    // 特殊运算符
    public static final int addADD = 3737;
    public static final int subSUB = 3838;
    public static final int MOD = 3939;
    ...
    public static int isKeyID(String str) {
        String keystr[] = {"char", "short", "int", "long", "float", "double", "final", "static", "if", "else", "while",
                "do", "for", "break", "continue", "void", "return", "struct", "until", "repeat", "int32"};
...
//                    System.out.println("该常量" + str + "的词法不正确");
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            if (arrayList.get(i).length() == 1) {
                if (arrayList.get(i).equals("%")){ // 运算符%
                    result.add(new Pair(MOD,arrayList.get(i)));
                    ...
                    } else if (arrayList.get(i + 1).equals("+")) { //后面跟"+"
                        result.add(new Pair(addADD, arrayList.get(i) + arrayList.get(++i)));
                    } else { // 否则是运算符"+"
                    ...
                    if ((arrayList.get(i - 1).equals("=") || arrayList.get(i - 1).equals("("))
                        ...
                        result.add(new Pair(subSUB, arrayList.get(i) + arrayList.get(++i)));
                    } else { // 否则是运算符"-"
                ...
                if (arrayList.get(i).length()==1 || arrayList.get(i).equals("main")) {
                    result.add(new Pair(MAIN, arrayList.get(i)));
                }else {
                    result.add(new Pair(NUM, arrayList.get(i)));
                }
            } else { // 否则是无法识别的单词
    ...
    public static void main(String[] args) {
        ...
        String filepath = "D:\\Users\\13270\\Documents\\JavaProject\\SyntaxAnalyzer\\file\\test.txt";
        ...
        try {
            ...
            String outputPath = "D:\\Users\\13270\\Documents\\JavaProject\\SyntaxAnalyzer\\file\\input.txt";
    ...
    public static String toLexicalAnalyzer(String filepath) {
        final String blank = " ";
        final String newLine = "\n";
        StringBuffer sb = new StringBuffer();
        String fileStr = "";
        ...
        try {
            ...
            StringBuffer outputBuffer = new StringBuffer();
            for (Pair pair : result) {
                outputBuffer.append(pair.key).append(",").append(pair.value).append("\n");
            }
